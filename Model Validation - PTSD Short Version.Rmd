...
```
Cross Validation Summary of average performance for repeated symptom combinations across splits (model without cluster representation).
```{r Cross Validation Summary of average performance for repeated symptom combinations across splits (model without cluster representation)., echo=FALSE, message=FALSE}
...
```
Cross Validation Summary of average performance for repeated symptom combinations across splits (model with cluster representation).
```{r Cross Validation Summary of average performance for repeated symptom combinations across splits (model with cluster representation)., echo=FALSE, message=FALSE}
# Apply combo summary function to cv summary
